...
const WEEKS = {
  ...
  4: {
    ...
    guide: [
      ...
      "Content: for each question, type a short label → click the green question block → type <br>. Do not use the [bundle] block. Then Save.",
