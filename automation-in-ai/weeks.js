...
const WEEKS = {
  ...
  4: {
    ...
    tutorial: `
      ...
      <p>Sheets: your Week 3 spreadsheet, sheet <b>Form Responses 1</b>, headers Yes → Save. Then the small <b>+</b> → <b>Gmail</b> → <b>Send an email</b> (always add it new): To your own address, Subject New answers, the email text: one column → Save. Right-click the Sheets point → <b>Choose where to start</b> → <b>All</b> → Save — or it only finds new rows. Then <b>Run once</b> — one email per answer. Too many.</p>
